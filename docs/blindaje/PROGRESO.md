...
| 5 órdenes que Ventas cuenta "por cobrar" (con saldo real) pero el Reporte de Saldos excluye por `pagada_unificada` -- de las 5, **3 son sobrepagos reales** que Odoo sigue mostrando `partial` (no hay tolerancia que los cubra: son -38,98 / -46,44 / -56,63 USD) y la regla unificada los cuenta como "pagados, sin deuda" con la señal `sobreaplicada` aparte; las otras 2 son centavos genuinos (0,01 y 0,00 USD) que Ventas trata más estricto de lo necesario | S00061 (-38,98), S00182 (-46,44), S00795 (-56,63) = **142,05 USD de sobrepago real sin resolver**; S00237/S00454 sin materialidad | **investigado el 19-sep, no corregido**: la señal `sobreaplicada` ya existe y es correcta por diseño (decisión 10 del quiz) -- lo que falta son tus manos en Odoo para esos 142,05 USD, no un cambio de código |
