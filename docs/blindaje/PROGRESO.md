...
| [2.4 — Modularizar](2.4-modularizar.md) | treinta y seis piezas sacadas de `app.py`, con su medición A/B, y qué sigue |
...
| | 10-sep-2026 | hoy | |
|---|---:|---:|---|
| tests | 1.280 | **2.100** | +820 |
| cobertura total | — | **82,14 %** | la barrera subió de 74 a 74,9 |
