...
def pronto_pago_to_row(d: DescuentoProntoPago) -> Row:
    return {
        ...
        "ventana_pago_tipo": d.ventana_pago_tipo,
        "ventana_pago_dias": str(d.ventana_pago_dias),
...
def pronto_pago_from_row(r: Mapping[str, str]) -> DescuentoProntoPago:
    return DescuentoProntoPago(
        ...
        marca=r.get("marca", "*"),
        categoria=r.get("categoria", "*"),
        ventana_pago_tipo=r.get("ventana_pago_tipo", "vencimiento"),
        ventana_pago_dias=int(r.get("ventana_pago_dias", "3")),
...
def recompra_from_row(r: Mapping[str, str]) -> DescuentoRecompra:
    return DescuentoRecompra(
        ...
        min_unidades=p_dec(r.get("min_unidades") or r.get("min_cajas") or "0"),
        max_unidades=p_dec(r.get("max_unidades") or r.get("max_cajas") or "999999"),
        porcentaje=p_dec(r.get("porcentaje") or "0.03"),
        ventana_pago_tipo=r.get("ventana_pago_tipo") or "vencimiento",
        ventana_pago_dias=int(r.get("ventana_pago_dias") or "3"),
...
def promocion_to_row(p: PromocionPrimeraCompra) -> Row:
    return {
        ...
        "categorias_descuento": p.categorias_descuento,
...
def promocion_from_row(r: Mapping[str, str]) -> PromocionPrimeraCompra:
    return PromocionPrimeraCompra(
        ...
        categorias_descuento=r.get("categorias_descuento", ""),
