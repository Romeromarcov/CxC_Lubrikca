...
# La pieza 21 (`monto_de_descuento_de_linea`) se borró el 12-sep-2026 junto con
# `_leer_descuentos_lineas_odoo`, su único llamador (decisión del usuario, quiz,
# pregunta 9). La regla entera vive en la pieza 23, abajo, con la misma precedencia.
